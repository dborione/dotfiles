# Generated by Powerlevel10k configuration wizard on 2023-06-07 at 12:38 CEST.
...
#	(( VCS_STATUS_PUSH_COMMITS_BEHIND  )) && res+="${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
...
#	(( VCS_STATUS_NUM_UNTRACKED  )) && res+="${untracked}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}" 
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=178
